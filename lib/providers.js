      ...
      `https://generativelanguage.googleapis.com/v1beta/models/${GEMINI_MODEL}:generateContent`,
      {
        ...
        body: JSON.stringify({
          ...
          generationConfig: {
            ...
            temperature: 0.6,
            // thinkingConfig (desactivar el "razonamiento" para ahorrar
            // tokens) se quitó a propósito: su soporte varía según la
            // versión exacta del modelo/API, y no vale la pena arriesgar
            // que TODA petición falle por un campo opcional de ahorro de
            // coste. Prioridad: que funcione, antes que optimizar tokens.
          },
        }),
      }
    );
