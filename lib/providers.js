...
// temporal — el propio mensaje de Google dice "usually temporary"), 429
// (límite de tasa, no de cuota total), 529 (código propio de Anthropic
// para "Overloaded", documentado en su API — equivalente exacto al 503 de
// Gemini) y fallos de red/timeout. Un 400 (petición mal formada) o 404
// (modelo inexistente) fallarán exactamente igual en el siguiente intento
// — reintentarlos solo alarga la espera del usuario sin ninguna
...
function isRetryableError(error) {
  ...
  if (/estado 529/.test(message)) return true;
