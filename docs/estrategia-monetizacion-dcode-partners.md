...
4. **WhatsApp IA — línea de roadmap, no de catálogo (v1.1):** una vez se provisione la credencial de WhatsApp Business API y se construya el workflow, incorporarlo de nuevo a §2/§3/§4/§6/§7.4 con precio propio (banda C, orientativo 4.200–5.800 € implantación / 320–420 €/mes, a confirmar con horas reales de build). Hasta entonces no debe cotizarse ni prometerse en ninguna conversación comercial.
